...
async function run() {
  try {
    ...
    // Note: Make sure use verifyAdmin after verigyJwt
    ...
    // temporary to update price on field on appointment | onkdur develop korar por jodi kono new data in korano lage tahole aita korbo and then comment must be
